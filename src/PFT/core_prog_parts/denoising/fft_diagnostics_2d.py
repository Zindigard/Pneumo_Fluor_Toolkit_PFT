...
The module contains the exact diagnostic quantities used by the thesis results
section and additional frequency-domain measurements used for quality control.
It does not normalize or modify the input image.
