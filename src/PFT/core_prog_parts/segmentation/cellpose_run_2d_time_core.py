"""Provide command-line and programmatic utilities for cellpose run two-dimensional data time core."""
...
class CellposeRun2DTimeConfig:
    """Store validated configuration or result data for cellpose run2 dtime config."""
    ...
    def root(self) -> Path:
        ...
        Example:
            >>> instance = CellposeRun2DTimeConfig(...)
...
def run_cellpose_dataset(cfg: CellposeRun2DTimeConfig) -> Path:
    ...
    Args:
        cfg (CellposeRun2DTimeConfig): Value specifying cfg for the operation.
