"""Provide command-line and programmatic utilities for stardist run two-dimensional data time core."""
...
def run_stardist_2d_time(cfg: StarDistRunConfig | None = None) -> list[Path]:
    """Run stardist two-dimensional data time using the supplied configuration.
