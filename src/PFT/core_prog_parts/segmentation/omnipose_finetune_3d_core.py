"""Provide command-line and programmatic utilities for omnipose finetune three-dimensional data core."""
...
def finetune_omnipose_3d(cfg: OmniposeFineTuneConfig | None = None) -> Path:
    """Return finetune omnipose three-dimensional data for the supplied inputs.
