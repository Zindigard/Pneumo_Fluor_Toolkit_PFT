"""Provide command-line and programmatic utilities for omnipose run two-dimensional data time core."""
...
def run_omnipose_2d_time(cfg: OmniposeRunConfig | None = None) -> list[Path]:
    """Run omnipose two-dimensional data time using the supplied configuration.
