"""Provide command-line and programmatic utilities for stardist run three-dimensional data core."""
...
def run_stardist_3d(cfg: StarDistRunConfig | None = None) -> list[Path]:
    """Run stardist three-dimensional data using the supplied configuration.
