"""Provide command-line and programmatic utilities for stardist finetune three-dimensional data core."""
...
def finetune_stardist_3d(cfg: StarDistFineTuneConfig | None = None) -> Path:
    """Return finetune stardist three-dimensional data for the supplied inputs.
