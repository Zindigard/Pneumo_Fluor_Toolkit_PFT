"""Provide command-line and programmatic utilities for stardist finetune two-dimensional data wga dapi core."""
...
def finetune_stardist_2d_wga_dapi(cfg: StarDistFineTuneConfig | None = None) -> Path:
    """Return finetune stardist two-dimensional data wga dapi for the supplied inputs.
    ...
    Example:
        >>> result = finetune_stardist_2d_wga_dapi()
    """
    if cfg is None:
