...
from PFT.core_prog_parts.segmentation.omnipose_run_2d_time_core import OmniposeRunConfig as Config2DTime, run_omnipose_2d_time
from PFT.core_prog_parts.segmentation.omnipose_run_2d_wga_dapi_core import OmniposeRunConfig as Config2DWgaDapi, run_omnipose_2d_wga_dapi
from PFT.core_prog_parts.segmentation.omnipose_run_3d_core import OmniposeRunConfig as Config3D, run_omnipose_3d


def main() -> int:
    root = find_project_root()
    print("\nChoose Omnipose prediction dataset:")
    print("1) 2d_time")
    print("2) 2d_wga_dapi")
    print("3) 3d")
