...
from PFT.core_prog_parts.segmentation.stardist_finetune_2d_time_core import StarDistFineTuneConfig as Config2DTime, finetune_stardist_2d_time
from PFT.core_prog_parts.segmentation.stardist_finetune_2d_wga_dapi_core import StarDistFineTuneConfig as Config2DWgaDapi, finetune_stardist_2d_wga_dapi
from PFT.core_prog_parts.segmentation.stardist_finetune_3d_core import StarDistFineTuneConfig as Config3D, finetune_stardist_3d
...
def main() -> int:
    ...
    print("\nChoose StarDist fine-tuning dataset:")
    print("1) 2d_time")
    print("2) 2d_wga_dapi")
    print("3) 3d")
    ...
    if choice == "1":
        ...
        if hasattr(cfg, "n_epochs"):
            cfg.n_epochs = ask_int("Epochs", cfg.n_epochs)
        finetune_stardist_2d_wga_dapi(cfg)
    elif choice == "3":
