...
from PFT.core_prog_parts.segmentation.stardist_run_2d_time_core import StarDistRunConfig as Config2DTime, run_stardist_2d_time
from PFT.core_prog_parts.segmentation.stardist_run_2d_wga_dapi_core import StarDistRunConfig as Config2DWgaDapi, run_stardist_2d_wga_dapi
from PFT.core_prog_parts.segmentation.stardist_run_3d_core import StarDistRunConfig as Config3D, run_stardist_3d


def main() -> int:
    root = find_project_root()
    print("\nChoose StarDist prediction dataset:")
    print("1) 2d_time")
    print("2) 2d_wga_dapi")
    print("3) 3d")
