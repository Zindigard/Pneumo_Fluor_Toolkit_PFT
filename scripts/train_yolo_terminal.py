...
from PFT.core_prog_parts.yolo_finetune_2d_time_core import YOLOFineTuneConfig as Config2DTime, finetune_yolo_2d_time
from PFT.core_prog_parts.yolo_finetune_2d_wga_dapi_core import YOLOFineTuneConfig as Config2DWgaDapi, finetune_yolo_2d_wga_dapi
from PFT.core_prog_parts.yolo_finetune_3d_core import YOLOFineTuneConfig as Config3D, finetune_yolo_3d
...
def main() -> int:
    ...
    print("\nChoose YOLO fine-tuning dataset:")
    print("1) 2d_time")
    print("2) 2d_wga_dapi")
    print("3) 3d")
