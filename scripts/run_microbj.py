...
PROJECT_ROOT_GUESS = THIS_FILE.parents[1] if THIS_FILE.parent.name == "scripts" else THIS_FILE.parent
SRC = PROJECT_ROOT_GUESS / "src"
if SRC.exists() and str(SRC) not in sys.path:
    sys.path.insert(0, str(SRC))

from PFT.core_prog_parts.microbej_runner_core import (  # noqa: E402
    collect_tiff_images,
    find_project_root,
    run_microbej_batch,
)
